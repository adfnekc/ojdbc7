...
public final class NVPair {
    ...
    public NVPair(String var1, String var2) throws InvalidSyntaxException {
        this(var1);
        this.setAtom(var2);
    }
    ...
    public void setAtom(String var1) throws InvalidSyntaxException {
        if (this._name.indexOf("COMMENT") == -1 && this.containsComment(var1)) {
            Object[] var2 = new Object[]{"#", this.getName()};
            throw new InvalidSyntaxException("UnexpectedChar-04603", var2);
        } else {
    ...
    public String toString(int var1, boolean var2) {
        ...
        if (this._rhsType == RHS_LIST) {
            if (this._listType == LIST_REGULAR) {
                ...
                if (!var5.equals("")) {
                    if (!var4.equalsIgnoreCase("ADDRESS") && !var4.equalsIgnoreCase("RULE")) {
                        var3 = var3 + this.space(var1 * 2) + "(" + this._name + " =" + this._linesep;
                    } else {
                    ...
                    if (!var4.equalsIgnoreCase("ADDRESS") && !var4.equalsIgnoreCase("RULE")) {
                        if (var1 == 0) {
                            ...
                            var3 = var3 + this.space(var1 * 2) + ")" + this._linesep;
                        }
                    } else {
                        var3 = var3 + ")" + this._linesep;
                    }
                }
            } else if (this._listType == LIST_COMMASEP) {
            ...
            if (var1 == 0) {
                ...
                this._atom = this.modifyCommentString(this._atom);
                var3 = var3 + this._atom + this._linesep;
            } else if (!var2) {
                var3 = var3 + "(" + this._name + " = " + this._atom + ")";
            } else {
