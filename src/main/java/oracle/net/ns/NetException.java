...
public class NetException extends IOException {
    ...
    public NetException(int var1) {
        this.message = null;
        this.errorNumber = var1;
        this.message = new Message11();
    }

    public NetException(int var1, String var2) {
        this(var1);
        this.userMsg = var2;
    }
    ...
    public String getMessage() {
        return this.message == null ? Integer.toString(this.errorNumber) : this.message.getMessage(this.errorNumber, this.userMsg);
    }
}
