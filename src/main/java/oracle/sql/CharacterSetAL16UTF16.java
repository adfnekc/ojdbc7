...
class CharacterSetAL16UTF16 extends CharacterSet implements CharacterRepConstants {
    ...
    CharacterSetAL16UTF16(int var1) {
        super(var1);
        this.rep = 4;
    }
    ...
    public String toStringWithReplacement(byte[] var1, int var2, int var3) {
        try {
            ...
            int var5 = CharacterSet.convertAL16UTF16BytesToJavaChars(var1, var2, var4, 0, var3, true);
    ...
    public String toString(byte[] var1, int var2, int var3) throws SQLException {
        try {
            char[] var4 = new char[var3 >>> 1];
            int var5 = CharacterSet.convertAL16UTF16BytesToJavaChars(var1, var2, var4, 0, var3, false);
            return new String(var4, 0, var5);
        } catch (SQLException var6) {
            failUTFConversion();
            return "";
    ...
    public byte[] convert(String var1) throws SQLException {
        return stringToAL16UTF16Bytes(var1);
    }
    ...
    public byte[] convert(CharacterSet var1, byte[] var2, int var3, int var4) throws SQLException {
        ...
        if (var1.rep == 4) {
            ...
            var5 = stringToAL16UTF16Bytes(var6);
        }
