...
class T4CLongAccessor extends LongAccessor implements T4CAccessor {
   ...
   T4CLongAccessor(OracleStatement var1, int var2, int var3, short var4, int var5, T4CMAREngine var6) throws SQLException {
   ...
   T4CLongAccessor(OracleStatement var1, int var2, int var3, boolean var4, int var5, int var6, int var7, int var8, int var9, short var10, int var11, int var12, T4CMAREngine var13) throws SQLException {
   ...
   private final T4CMarshaller getMarshaller() {
      if (this.marshaller == null) {
         this.marshaller = this.describeType != 8 && this.describeType != 112 ? T4CMarshaller.VARCHAR : T4CMarshaller.LONG;
      }
