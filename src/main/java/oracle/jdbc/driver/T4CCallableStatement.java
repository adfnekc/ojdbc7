...
class T4CCallableStatement extends OracleCallableStatement {
   ...
   T4CCallableStatement(PhysicalConnection var1, String var2, int var3, int var4) throws SQLException {
      super(var1, var2, var1.defaultExecuteBatch, var1.defaultRowPrefetch, var3, var4);
   ...
   void doOall8(boolean var1, boolean var2, boolean var3, boolean var4, boolean var5, int var6) throws SQLException, IOException {
      ...
      if (this.sqlKind == oracle.jdbc.internal.OracleStatement.SqlKind.UNINITIALIZED) {
         ...
         try {
            var19.doOALL(var1, var2, var3, var4, var5, this.sqlKind, this.cursorId, this.sqlObject.getSqlBytes(this.processEscapes, this.convertNcharLiterals), var7, this.outBindAccessors, this.numberOfBindPositions, this.accessors, var8, this.bindBytes, this.bindChars, this.bindIndicators, this.bindIndicatorSubRange, this.connection.conversion, this.tmpBindsByteArray, this.parameterStream, this.parameterDatum, this.parameterOtype, this, this.ibtBindBytes, this.ibtBindChars, this.ibtBindIndicators, this.oacdefSent, var17, var20, var18, this.registration);
   ...
   Binder getRowidNullBinder(int var1) {
      if (this.sqlKind == oracle.jdbc.internal.OracleStatement.SqlKind.CALL_BLOCK) {
         this.currentRowCharLens[var1] = 1;
   ...
   Accessor allocateIndexTableAccessor(PlsqlIbtBindInfo var1, short var2) throws SQLException {
      return new T4CPlsqlIndexTableAccessor(this, var1, var2, this.t4Connection.mare);
   }

   void endOfResultSet(boolean var1) throws SQLException {
      super.endOfResultSet(var1);
      this.rowData.free();
   }
}
