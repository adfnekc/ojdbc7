...
class T4CIntervalymAccessor extends IntervalymAccessor {
   ...
   T4CIntervalymAccessor(OracleStatement var1, int var2, short var3, int var4, boolean var5, T4CMAREngine var6) throws SQLException {
      super(var1, 5, var3, var4, var5);
      this.mare = var6;
   }

   T4CIntervalymAccessor(OracleStatement var1, int var2, boolean var3, int var4, int var5, int var6, int var7, int var8, short var9, int var10, int var11, T4CMAREngine var12) throws SQLException {
      super(var1, 5, var3, var4, var5, var6, var7, var8, var9);
      this.mare = var12;
