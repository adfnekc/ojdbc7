...
class T4CPlsqlIndexTableAccessor extends PlsqlIndexTableAccessor {
   ...
   T4CPlsqlIndexTableAccessor(OracleStatement var1, PlsqlIbtBindInfo var2, short var3, T4CMAREngine var4) throws SQLException {
   ...
   boolean unmarshalBytes() throws SQLException, IOException {
      ...
      if (var1 != 0) {
         ...
         this.rowData.putInt(var1);
         var2 = 0;

         do {
            long var3 = this.rowData.getPosition();
            this.rowData.putShort((short)0);
            int var5 = ((DynamicByteArray)this.rowData).unmarshalCLR(this.mare);
            this.rowData.putShort(var3, (short)var5);
            this.processIndicator(var5);
            ++var2;
         } while(var2 != var1);
      }

      var2 = (int)(this.rowData.getPosition() - this.getOffset(this.lastRowProcessed));
