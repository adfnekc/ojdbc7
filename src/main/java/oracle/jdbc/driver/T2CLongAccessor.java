...
class T2CLongAccessor extends LongAccessor {
    ...
    T2CLongAccessor(OracleStatement var1, int var2, int var3, short var4, int var5) throws SQLException {
        super(var1, var2, var3, var4, var5);
    }

    T2CLongAccessor(OracleStatement var1, int var2, int var3, boolean var4, int var5, int var6, int var7, int var8, int var9, short var10) throws SQLException {
    ...
    InputStream getAsciiStream(int var1) throws SQLException {
        if (this.statement.isFetchStreams) {
            if (this.isNull(var1)) {
                ...
                InputStream var3;
                try {
                    var3 = this.statement.connection.conversion.ConvertStream(var2, 0);
                } finally {
                    try {
                        if (var2 != null) {
                            var2.close();
    ...
    InputStream getUnicodeStream(int var1) throws SQLException {
        if (this.statement.isFetchStreams) {
            if (this.isNull(var1)) {
                ...
                InputStream var3;
                try {
                    var3 = this.statement.connection.conversion.ConvertStream(var2, 1);
                } finally {
                    try {
                        if (var2 != null) {
                            var2.close();
    ...
    Reader getCharacterStream(int var1) throws SQLException {
        if (this.statement.isFetchStreams) {
            if (this.isNull(var1)) {
                ...
                Reader var3;
                try {
                    var3 = this.statement.connection.conversion.ConvertCharacterStream(var2, 9, this.formOfUse);
                } finally {
                    try {
                        if (var2 != null) {
                            var2.close();
    ...
    InputStream getBinaryStream(int var1) throws SQLException {
        if (this.statement.isFetchStreams) {
            if (this.isNull(var1)) {
                ...
                InputStream var3;
                try {
                    var3 = this.statement.connection.conversion.ConvertStream(var2, 6);
                } finally {
                    try {
                        if (var2 != null) {
                            var2.close();
    ...
    Accessor copyForDefine(OracleStatement var1) {
        LongAccessor var2 = (LongAccessor)super.copyForDefine(var1);
