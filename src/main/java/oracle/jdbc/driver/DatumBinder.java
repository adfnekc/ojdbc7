...
abstract class DatumBinder extends Binder {
    ...
    long bind(OraclePreparedStatement var1, int var2, int var3, int var4, byte[] var5, char[] var6, short[] var7, int var8, int var9, int var10, int var11, int var12, int var13, boolean var14, long var15) {
        ...
        if (var18 == null) {
            ...
            var7[var13] = 0;
            System.arraycopy(var18, 0, var5, var10, var18.length);
            var7[var12] = (short)var18.length;
        }

        if (!this.skipBindChecksumForLobs && var1.connection.checksumMode.needToCalculateBindChecksum()) {
            CRC64 var10000;
            if (var7[var13] == -1) {
