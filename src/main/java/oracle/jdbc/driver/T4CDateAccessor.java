...
class T4CDateAccessor extends DateAccessor {
   ...
   T4CDateAccessor(OracleStatement var1, int var2, short var3, int var4, boolean var5, T4CMAREngine var6) throws SQLException {
      super(var1, var2, var3, var4, var5);
      this.mare = var6;
   }

   T4CDateAccessor(OracleStatement var1, int var2, boolean var3, int var4, int var5, int var6, int var7, int var8, short var9, int var10, int var11, T4CMAREngine var12) throws SQLException {
   ...
   String toText(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, String var9) throws SQLException {
      if (this.definedColumnType != 0 && this.definedColumnType != 91) {
         String var10 = (String)this.statement.connection.sessionProperties.get("AUTH_NLS_LXCDATEFM");
   ...
   String getString(int var1) throws SQLException {
      ...
      if (this.definedColumnType == 0) {
         ...
         boolean var4 = false;
         int var5;
         var2 = this.toText(var3, this.oracleMonth(this.tmpBytes) + 1, this.oracleDay(this.tmpBytes), var5 = this.oracleHour(this.tmpBytes), this.oracleMin(this.tmpBytes), this.oracleSec(this.tmpBytes), -1, var5 < 12, (String)null);
      }
