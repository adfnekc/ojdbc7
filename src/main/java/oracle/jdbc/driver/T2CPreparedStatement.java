...
class T2CPreparedStatement extends OraclePreparedStatement {
   ...
   T2CPreparedStatement(T2CConnection var1, String var2, int var3, int var4, int var5, int var6) throws SQLException {
   ...
   void doDefineExecuteFetch() throws SQLException {
      ...
      try {
         this.resetStateBeforeFetch();
         this.validRows = T2CStatement.t2cDefineExecuteFetch(this, this.c_state, this.numberOfDefinePositions, this.numberOfBindPositions, this.numberOfBindRowsAllocated, this.firstRowInBatch, false, this.needToParse, var2, var2.length, T2CStatement.convertSqlKindEnumToByte(this.sqlKind), var3, this.batch, this.bindIndicators, this.bindIndicatorOffset, this.bindBytes, this.bindChars, this.bindByteOffset, this.bindCharOffset, var1, this.t2cConnection.queryMetaData2, this.t2cConnection.queryMetaData1Offset, this.t2cConnection.queryMetaData2Offset, this.preparedByteBinds, this.preparedCharBinds, this.accessors, this.parameterDatum, this.t2cOutput, this.nioBuffers, this.lobPrefetchMetaData);
         if (this.bindIndicators != null) {
            this.setLengthForOutAccessors();
         }
