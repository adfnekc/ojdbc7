...
public class OracleTypeTIMESTAMPTZ extends OracleType implements Serializable {
    ...
    public OracleTypeTIMESTAMPTZ(OracleConnection var1) {
    ...
    protected Object toObject(byte[] var1, int var2, Map var3) throws SQLException {
        if (var1 != null && var1.length != 0) {
            switch(var2) {
                case 1:
                    return new TIMESTAMPTZ(var1);
                case 2:
                    return TIMESTAMPTZ.toTimestamp(this.connection, var1);
                case 3:
                    return var1;
                default:
        ...
        if (var1 != null) {
            try {
                if (var1 instanceof TIMESTAMPTZ) {
                    var3 = (TIMESTAMPTZ)var1;
                } else if (var1 instanceof byte[]) {
                    var3 = new TIMESTAMPTZ((byte[])((byte[])var1));
                } else if (var1 instanceof Timestamp) {
                    var3 = new TIMESTAMPTZ(var2, (Timestamp)var1);
                } else if (var1 instanceof DATE) {
                    var3 = new TIMESTAMPTZ(var2, (DATE)var1);
                } else if (var1 instanceof String) {
                    var3 = new TIMESTAMPTZ(var2, (String)var1);
                } else if (var1 instanceof Date) {
                    var3 = new TIMESTAMPTZ(var2, (Date)var1);
                } else {
                    ...
                    var3 = new TIMESTAMPTZ(var2, (Time)var1);
                }
