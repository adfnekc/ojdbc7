...
public class OracleTypeBINARY_DOUBLE extends OracleType implements Serializable {
    ...
    public Datum toDatum(Object var1, OracleConnection var2) throws SQLException {
        BINARY_DOUBLE var3 = null;
        if (var1 != null) {
            if (var1 instanceof BINARY_DOUBLE) {
                var3 = (BINARY_DOUBLE)var1;
            } else if (var1 instanceof Double) {
                var3 = new BINARY_DOUBLE((Double)var1);
            } else {
                ...
                var3 = new BINARY_DOUBLE((byte[])((byte[])var1));
            }
        }
    ...
    protected Object toObject(byte[] var1, int var2, Map var3) throws SQLException {
        if (var1 != null && var1.length != 0) {
            if (var2 == 1) {
                ...
                return (new BINARY_DOUBLE(var1)).toJdbc();
            } else if (var2 == 3) {
                return var1;
            } else {
                SQLException var4 = DatabaseError.createSqlException(this.getConnectionDuringExceptionHandling(), 59, var1);
