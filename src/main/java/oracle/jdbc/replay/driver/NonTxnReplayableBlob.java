...
public abstract class NonTxnReplayableBlob extends NonTxnReplayableBase implements Replayable {
   ...
   private static final Method getGetBinaryStreamMethod() {
      try {
         return oracle.jdbc.internal.OracleBlob.class.getMethod("getBinaryStream");
   ...
   public InputStream getBinaryStream() throws SQLException {
      if (GETBINSTREAM_METHOD == null) {
         ...
         try {
            oracle.jdbc.internal.OracleBlob var2 = (oracle.jdbc.internal.OracleBlob)this.getDelegate();
            if (this.isFreed) {
               ...
               if (var2.canReadBasicLobDataInLocator()) {
                  ...
                  var3 = var2.getDBAccess().newInputStream((oracle.jdbc.internal.OracleBlob)this, var2.getBufferSize(), 0L);
               }
   ...
   public InputStream getBinaryStream(long var1) throws SQLException {
      if (GETBINSTREAM_LONG_METHOD == null) {
         ...
         try {
            oracle.jdbc.internal.OracleBlob var4 = (oracle.jdbc.internal.OracleBlob)this.getDelegate();
            if (this.isFreed) {
               ...
               if (var4.canReadBasicLobDataInLocator()) {
                  ...
                  var5 = var4.getDBAccess().newInputStream((oracle.jdbc.internal.OracleBlob)this, var4.getBufferSize(), var1);
               }
   ...
   public InputStream getBinaryStream(long var1, long var3) throws SQLException {
      if (GETBINSTREAM_LONG_LONG_METHOD == null) {
         ...
         try {
            oracle.jdbc.internal.OracleBlob var6 = (oracle.jdbc.internal.OracleBlob)this.getDelegate();
            if (this.isFreed) {
               ...
               if (var6.canReadBasicLobDataInLocator()) {
                  ...
                  var7 = var6.getDBAccess().newInputStream((oracle.jdbc.internal.OracleBlob)this, var6.getBufferSize(), var1, var3);
               }
      ...
      if (SETBINSTREAM_LONG_METHOD == null) {
         ...
         try {
            ...
            if (this.isFreed) {
               ...
               OutputStream var5 = var4.getDBAccess().newOutputStream((oracle.jdbc.internal.OracleBlob)this, var4.getBufferSize(), var1, true);
   ...
   public OracleConnection getInternalConnection() throws SQLException {
      oracle.jdbc.internal.OracleBlob var1 = (oracle.jdbc.internal.OracleBlob)this.getDelegate();
