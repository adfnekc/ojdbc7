...
public abstract class NonTxnReplayableClob extends NonTxnReplayableBase implements Replayable {
   ...
   private static final Method getGetAsciiStreamMethod() {
      try {
         return oracle.jdbc.internal.OracleClob.class.getMethod("getAsciiStream");
   ...
   private static final Method getGetCharacterStreamMethod() {
      try {
         return oracle.jdbc.internal.OracleClob.class.getMethod("getCharacterStream");
      } catch (Exception var1) {
         return null;
      }
   }
   ...
   public InputStream getAsciiStream() throws SQLException {
      if (GETASCIISTREAM_METHOD == null) {
         ...
         try {
            oracle.jdbc.internal.OracleClob var2 = (oracle.jdbc.internal.OracleClob)this.getDelegate();
            if (this.isFreed) {
               ...
               if (var2.canReadBasicLobDataInLocator()) {
                  ...
                  var3 = var2.getDBAccess().newInputStream((oracle.jdbc.internal.OracleClob)this, var2.getBufferSize(), 0L);
               }
   ...
   public InputStream getAsciiStream(long var1) throws SQLException {
      if (GETASCIISTREAM_LONG_METHOD == null) {
         ...
         try {
            oracle.jdbc.internal.OracleClob var4 = (oracle.jdbc.internal.OracleClob)this.getDelegate();
            if (this.isFreed) {
               ...
               if (var4.canReadBasicLobDataInLocator()) {
                  ...
                  var5 = var4.getDBAccess().newInputStream((oracle.jdbc.internal.OracleClob)this, var4.getBufferSize(), var1);
               }
         ...
         try {
            ...
            if (this.isFreed) {
               ...
               if (var2.canReadBasicLobDataInLocator()) {
                  ...
                  var3 = var2.getDBAccess().newReader((oracle.jdbc.internal.OracleClob)this, var2.getBufferSize(), 0L);
               }
         ...
         try {
            ...
            if (this.isFreed) {
               ...
               if (var4.canReadBasicLobDataInLocator()) {
                  ...
                  var5 = var4.getDBAccess().newReader((oracle.jdbc.internal.OracleClob)this, var4.getBufferSize(), var1);
               }
   ...
   public Reader getCharacterStream(long var1, long var3) throws SQLException {
      if (GETCHARSTREAM_LONG_LONG_METHOD == null) {
         ...
         try {
            oracle.jdbc.internal.OracleClob var6 = (oracle.jdbc.internal.OracleClob)this.getDelegate();
            if (this.isFreed) {
               ...
               if (var6.canReadBasicLobDataInLocator()) {
                  ...
                  var7 = var6.getDBAccess().newReader((oracle.jdbc.internal.OracleClob)this, var6.getBufferSize(), var1, var3);
               }
      ...
      if (SETASCIISTREAM_LONG_METHOD == null) {
         ...
         try {
            ...
            if (this.isFreed) {
               ...
               OutputStream var5 = var4.getDBAccess().newOutputStream((oracle.jdbc.internal.OracleClob)this, var4.getBufferSize(), var1, true);
      ...
      if (SETCHARSTREAM_LONG_METHOD == null) {
         ...
         try {
            ...
            if (this.isFreed) {
               ...
               Writer var5 = var4.getDBAccess().newWriter((oracle.jdbc.internal.OracleClob)this, var4.getBufferSize(), var1, true);
   ...
   public OracleConnection getInternalConnection() throws SQLException {
      oracle.jdbc.internal.OracleClob var1 = (oracle.jdbc.internal.OracleClob)this.getDelegate();
