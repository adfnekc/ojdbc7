...
@ProxyFor({Array.class, OracleArray.class, oracle.jdbc.internal.OracleArray.class})
public abstract class NonTxnReplayableArray extends NonTxnReplayableBase implements Replayable {
   ...
   @ProxyResult(ProxyResultPolicy.CREATE)
   public abstract ResultSet getResultSet(long var1, int var3) throws SQLException;

   @ProxyResult(ProxyResultPolicy.CREATE)
   public abstract ResultSet getResultSet(long var1, int var3, Map var4) throws SQLException;

   @ProxyResult(ProxyResultPolicy.CREATE)
   public abstract ResultSet getResultSet(Map var1) throws SQLException;
}
