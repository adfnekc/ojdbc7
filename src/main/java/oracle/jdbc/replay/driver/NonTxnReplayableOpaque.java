...
@ProxyFor({OracleOpaque.class, oracle.jdbc.internal.OracleOpaque.class})
public abstract class NonTxnReplayableOpaque extends NonTxnReplayableBase implements Replayable {
