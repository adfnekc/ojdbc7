...
@ProxyFor({Ref.class, OracleRef.class, oracle.jdbc.internal.OracleRef.class})
public abstract class NonTxnReplayableRef extends NonTxnReplayableBase implements Replayable {
